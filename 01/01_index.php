                ...
                <div class="modal-body">
                    <form>
                        ...
                        <div class="result-container">
                            ...
                            <a href="01_index.php?page=01_op" class="link"><div class="manga-item" data-name="one piece">
                                <img src="anh/dop.jpg" alt="One Piece">
                                <h3>One Piece</h3>
                                <p>Thể loại: Action, Shounen,...</p>
                                <p>Luffy và băng Mũ Rơm tìm kiếm kho báu One Piece.</p>
                            </div></a>
                            <a href="01_index.php?page=01_solo" class="link"><div class="manga-item" data-name="solo leveling">
                            ...
                            <a href="01_index.php?page=01_dan" class="link"><div class="manga-item" data-name="dan da dan">
                            ...
                            <a href="01_index.php?page=01_aot" class="link"><div class="manga-item" data-name="attack on titan">
                            ...
                            <a href="01_index.php?page=01_hero" class="link"><div class="manga-item" data-name="my hero academia">
                            ...
                            <a href="01_index.php?page=01_iruma" class="link"><div class="manga-item" data-name="mairimashita! iruma-kun">
        ...
        if(isset($_GET['page'])){
            switch($_GET['page']){
                ...
                case '01_hero':
                    ...
                    break;
                case '01_iruma':
                    include "01_iruma.php";
                    break;
                case '01_action':
                    include "01_action.php";
                    break;
                case '01_adventure':
                    include "01_adventure.php";
                    break;
                case '01_comedy':
                    include "01_comedy.php";
                    break;
                case '01_drama':
                    include "01_drama.php";
                    break;
                case '01_shounen':
                    include "01_shounen.php";
                    break;
                case '01_mystery':
                    include "01_mystery.php";
                    break;
            }
        }
        else{
