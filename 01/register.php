    ...
    <div class="fixed-icon">
     ...
     <div class="login-container" style="margin-top: 50px;">
            ...
            <form id="loginForm" action="register.php" method="post">
                ...
                <input type="password" name="rppassword" placeholder="Nhập lại mật khẩu của bạn" id="pass" required>                
                <button type="submit" style="background-color: red;">Đăng ký</button>
            ...
            include('connect.php');
            if(isset($_POST['username']) && isset($_POST['password']) && isset($_POST['rppassword'])){
                if($_POST['password'] != $_POST['rppassword']){
                    echo "<p style='color: red; padding-top: 5px;' class='warning'>Mật khẩu không trùng khớp</p>";
                }
                else{
                    ...
                    if ($result->num_rows > 0){
                        echo "<p style='color: red; padding-top: 5px;' class='warning'>Tài khoản đã tồn tại</p>";
                    }
                    else{
                        $username = $_POST['username'];
