...
<body>
    ...
    <section class="banner content-wrapper mt-4 d-block">
        <img class="abc" src="anh/nsolo.jpg"
            alt="Banner">
        <!-- Main Content -->
        <main class="content">
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="card p-3 mb-4">
                    ...
                    Theo chân Sung JinWoo trên hành trình từ "thợ săn kém cỏi" đến "thợ săn hạng S mạnh nhất thế giới". Theo chân Sung JinWoo trên hành trình từ "thợ săn kém cỏi" đến "thợ săn hạng S mạnh nhất thế giới
                    </div>
                <div class="card p-3">
