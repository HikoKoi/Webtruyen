    ...
    <div class="slider-container">
        <div class="slides">
            ...
            <div class="slide" id="slide1">
                <a href="01_index.php?page=01_aot"><img src="anh/naot.jpg" alt="Banner 1"></a>
            ...
            <div class="slide" id="slide2">
                <a href="01_index.php?page=01_dan"><img src="anh/ndan.jpg" alt="Banner 2"></a>
            ...
            <div class="slide" id="slide3">
                <a href="01_index.php?page=01_hero"><img src="anh/nhero.jpg" alt="Banner 3"></a>
                <div class="slide-info" data-title="Another Great Story" data-desc="Thêm nội dung thú vị...">
                </div>
            </div>
            <!-- Slide 4 -->
            <div class="slide" id="slide4">
                <a href="01_index.php?page=01_solo"><img src="anh/nsolo.jpg" alt="Banner 4"></a>
                <div class="slide-info" data-title="solo leveling" data-desc="Thêm nội dung thú vị...">
                </div>
            </div>
            <!-- slide 5 -->
            <div class="slide" id="slide5">
                <a href="01_index.php?page=01_op"><img src="anh/nop.jpg" alt="Banner 5"></a>
                <div class="slide-info" data-title="one piece" data-desc="Thêm nội dung thú vị...">
                </div>
            </div>
            <!-- slide 6 -->
            <div class="slide" id="slide6">
                <a href="01_index.php?page=01_iruma"><img src="anh/niruma.jpg"  alt="Banner 6"></a>
