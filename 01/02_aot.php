            ...
            <div class="d-flex flex-wrap">
                ...
                <div class="col-md-10 ps-md-4">
                    ...
                    <div class="mt-3">
                        ...
                        <a href="doctruyen.php?story_id=3&chapter_number=1"><button href="#" class="btn btn-primary">Đọc Từ Chương 1</button></a>
                    </div>
                </div>
            </div>
        </main>
                    ...
                    <div class="chapter-list mt-3">
                        <div class="chapter-item p-2 d-flex justify-content-between align-items-center border-bottom">
                            <div class="text-align-left">
                                <a href="doctruyen.php?story_id=3&chapter_number=1" class="link"><h6>Chương 1</h6></a>
                            ...
                            <a href="doctruyen.php?story_id=3&chapter_number=1" class="btn btn-light">
            ...
            <div class="col-md-8">
                <div class="card p-3">
                    ...
                    <div class="list-group">
                        ...
                        <div class="list-group-item d-flex justify-content-between align-items-center">
                            <div>
                                <a href="doctruyen.php?story_id=3&chapter_number=2" class="link"><h6>Chương 2</h6></a>
                                <small>Không có tiêu đề</small>
                                <p class="text-muted">5 tháng trước - 3.5M lượt xem - 8 bình luận</p>
                            </div>
                            <a href="doctruyen.php?story_id=3&chapter_number=2" class="btn btn-light">
                                <i class="fas fa-check"></i>
                            </a>
                        </div>
                        <div class="list-group-item d-flex justify-content-between align-items-center">
