        ...
        <main class="content">
            <div class="d-flex flex-wrap">
                ...
                <div class="col-md-10 ps-md-4">
                    <h5>Tác giả : Eiichiro Oda</h5>
                    <h1>One Piece</h1>
                    <p style="color: white;">11 giờ trước</p>
                    <div class="mt-3">
                        <a href="01_index.php?page=01_action"><span class="badge bg-secondary">Action</span></a>
                        <a href="01_index.php?page=01_shounen"><span class="badge bg-secondary">Shounen</span></a>
                        <a href="01_index.php?page=01_adventure"><span class="badge bg-secondary">Adventure</span></a>
                        <a href="01_index.php?page=01_comedy"><span class="badge bg-secondary">Comedy</span></a>
                        <a href="01_index.php?page=01_drama"><span class="badge bg-secondary">Drama</span></a>
                       
                    </div>
                    <div class="mt-3">
                        <button href="#" class="btn btn-primary" disabled>Đăng nhập để theo dõi</button>
                        <!-- <a href="doctruyen.php?story_id=2"><button href="#" class="btn btn-primary">Đọc Từ Chương 1</button></a> -->
                    </div>
                </div>
            </div>
        </main>
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="card p-3 mb-4">
                    ...
                    <p class="mt-3" style="text-align: left;">One Piece là câu truyện kể về Luffy và các thuyền viên của mình. Khi còn nhỏ, Luffy ước mơ trở thành Vua Hải Tặc.
                         Cuộc sống của cậu bé thay đổi khi cậu vô tình có được sức mạnh có thể co dãn như cao su, nhưng đổi lại, cậu không bao giờ có thể bơi được nữa...</p>
                </div>
                <div class="card p-3">
                    ...
                    <div class="chapter-list mt-3">
                        <div class="chapter-item p-2 d-flex justify-content-between align-items-center border-bottom">
                            <div class="text-align-left">
                                <a href="#" class="link"><h6>Chương 1</h6></a>
            ...
            <div class="col-md-4">
                ...
                <ul class="list-unstyled">
                    <li class="d-flex align-items-center mb-2">
                        ...
                        <div>
                            <a href="01_index.php?page=01_hero" class="text-decoration-none">My hero Academia</a>
                    ...
                    <li class="d-flex align-items-center mb-2">
                        <img src="anh/daot.jpg"
                            class="rounded me-2" alt="Comic Cover">
                        <div>
                            <a href="01_index.php?page=01_aot" class="text-decoration-none">Attack on titan</a>
                    ...
                    <li class="d-flex align-items-center mb-2">
                        <img src="anh/ddan.jpg"
                            class="rounded me-2" alt="Comic Cover">
                        <div>
                            <a href="01_index.php?page=01_dan" class="text-decoration-none">Dan Da Dan</a>
                    ...
                    <li class="d-flex align-items-center mb-2">
                        <img src="anh/diruma.jpg"
                            class="rounded me-2" alt="Comic Cover">
                        <div>
                            <a href="01_index.php?page=01_iruma" class="text-decoration-none">Mairimashita! Iruma-kun</a>
                    ...
                    <li class="d-flex align-items-center mb-2">
                        <img src="anh/dsolo.jpg"
                            class="rounded me-2" alt="Comic Cover">
                        <div>
                            <a href="01_index.php?page=01_solo" class="text-decoration-none">Solo Leveling</a>
            ...
            <div class="col-md-8">
                <div class="card p-3">
                    ...
                    <div class="list-group">
                        ...
                        <div class="list-group-item d-flex justify-content-between align-items-center">
                            <div>
                                <a href="#" class="link"><h6>Chương 2</h6></a>
                                <small>Không có tiêu đề</small>
                ...
                <ul class="list-unstyled">
                    ...
                    <li class="d-flex mb-3">
                        <img src="anh/dop.jpg"
                            alt="Comic Cover" class="me-3 rounded">
                        <div>
                            <a href="01_index.php?page=01_op" class="text-decoration-none">One Piece</a>
